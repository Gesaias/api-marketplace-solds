...
```
 ...
 ## Documentation
 Prove uma documentação em **Swagger** com fácil manutenção, integração e testes de rotas. Depois da API levantada ela tera uma rota para acesso a documentação de rotas:
 [SwaggerDocsApi](http://localhost:3001/api/document).
